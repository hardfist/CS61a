...
class Place:
    ...
    def remove_insect(self, insect):
        ...
        if not insect.is_ant():
            ...
            "*** YOUR CODE HERE ***"
            if self.ant.container and self.ant.ant is not None:
...
class Ant(Insect):
    ...
    def can_contain(self,ant):
        if self.container == True and self.ant is None and not ant.container:
            return True
        else:
            return False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        dist = 0
        while True:
            if type(cur) is Hive or dist > self.max_range:
                return None
            elif cur.bees and dist >= self.min_range:
                break
            else:
                cur=cur.entrance
                dist += 1
...
class WallAnt(Ant):
    ...
    def __init__(self):
        "*** YOUR CODE HERE ***"
        Ant.__init__(self,WallAnt.armor)
...
class QueenPlace:
    ...
    def bees(self):
        "*** YOUR CODE HERE ***"
        if self.colony_queen == self.ant_queen:
            return self.ant_queen.bees
        else:
...
class QueenAnt(ScubaThrower):
    ...
    def action(self, colony):
        ...
        if not hasattr(self,"doubledList"):
            self.doubledList=[]
        cur = self.place
        tunnel=[]
        while True:
        ...
        for place in tunnel:
            if place.ant and place.ant not in self.doubledList:
                place.ant.damage*=2
                if place.ant.container:
                    place.ant.ant.damage*=2
                self.doubledList.append(place.ant)
